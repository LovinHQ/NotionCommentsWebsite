...
export function Header({ navigation }) {
  return (
    <header className="fixed top-0 z-20 w-full">
      <nav className="relative z-50 flex h-16 w-full flex-row-reverse items-center justify-between border-b border-[var(--bg-border)] bg-[var(--bg-sub)] px-4 sm:px-6 md:flex-row md:px-8">
