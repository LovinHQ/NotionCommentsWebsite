    ...
    <button
      ...
      className={clsx(
        ...
        `group flex select-none items-center justify-center gap-1 bg-[var(--accent-base)] font-medium
          ...
          ease-in-out
          hover:cursor-pointer hover:bg-[var(--accent-shade)] disabled:cursor-default disabled:bg-[var(--accent-bg)]
          `,
        className
      )}
    >
      ...
      {text && (
        <span
          className={`text-[var(--accent-label)] group-disabled:text-[var(--accent-muted)]`}
        >
          {text}
        </span>
      )}
